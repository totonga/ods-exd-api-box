...
class FileSimpleExample2(FileSimpleInterface):
    """
    ...
    def column_descriptions(self) -> list[str]:
        return [
            ...
            "Long uint16 column",
            "Long int32 column",
            "Long long uint32 column",
            "Long long int64 column",
            "Double uint64 column",
            "Float column",
            "Double column",
            "String column",
            "Date column",
    ...
    def file_attributes(self) -> dict[str, Any]:
        return {
            "file_type": "TEST_SIMPLE",
            "description": "This is a test simple file with various data types.",
        }
    ...
    def group_attributes(self) -> dict[str, Any]:
        return {
            ...
            "description": "This group contains test data.",
            "created_by": "FileSimpleExample",
        }
...
if __name__ == "__main__":
    ...
    serve_plugin_simple(
        ...
        file_type_factory=FileSimpleExample2.create,
